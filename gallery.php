...
<body class="bg-gray-100 text-gray-800 font-sans">
    ...
    <header class="bg-blue-900 text-white text-center p-6 text-2xl font-bold">
        Gallery | Yanto Priatna
    </header>
    <!-- Navigation -->
    <nav class="bg-blue-700 text-white py-3">
        <ul class="flex justify-center space-x-10 font-medium text-lg">
            <li>
                <a href="index.php" class="hover:underline">Artikel</a>
            </li>
            <li>
    ...
    <main class="max-w-6xl mx-auto p-6">
        <h2 class="text-xl font-bold mb-6 text-center">Galeri Foto
        </h2>
    ...
    <!-- Footer -->
    <footer class="bg-blue-800 text-white text-center py-4 mt-10"> &copy; 
        <?php echo date('Y'); ?> | Created by Yanto Priatna
    </footer>
</body>
</html>